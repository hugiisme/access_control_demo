<?php 
    ...
    if ($canCreate) {
        $buttonList[] = [
            ...
            "btn_url"  => "/pages/all_organizations/form.php?redirectLink=" . urlencode($reloadLink)
        ];
    }
    ...
    if ($canAssign) {
        $buttonList[] = [
            ...
            "btn_url"  => "/pages/all_organizations/assign.php?redirectLink=" . urlencode($reloadLink)
        ];
    }
