<?php 
    ...
    if (defined("IS_DEBUG") && !IS_DEBUG) {
        $can_assign_permissions = hasPermission($userId, "assign_permissions", null, "system_role_permissions");
    } else {    
    ...
    if ($can_assign_permissions) {
        $button_list[] = [
            ...
            "label"    => "Phân quyền",
            "btn_url"  => "/pages/system_role_permissions/assign_permissions.php?org_id=$org_id",
            "placement" => "table",
